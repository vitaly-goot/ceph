...
push_unique_to_logs_tobe_fetched() {
    ...
    if [ $session_max_duration -gt 86400 ]; then
        return
    fi
...
main() {
    ...
    if [ $session_max_duration -lt 86400 ]; then
